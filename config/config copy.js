...
config.development = {
  ...
  local: {
    ...
    storageDir: process.env.STORAGE_DIR || "/Users/codepush/storage",
    // Binary files download host address which Code Push Server listen to. the files storage in storageDir.
    downloadUrl: process.env.LOCAL_DOWNLOAD_URL || "http://172.16.57.160:3000",
  ...
  jwt: {
    ...
    tokenSecret: process.env.TOKEN_SECRET ||'seQlbAmYpToeL092tFsosvSePPXaNgRtdYd0bJDvpri9u7TUnOaOKBaPUlebuLX'
  },
  common: {
    /*
